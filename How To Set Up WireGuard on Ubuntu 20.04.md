...
If your peer has a browser installed, you can also visit [ipleak.net](https://ipleak.net/) and [ipv6-test.com](https://ipv6-test.com/) to confirm that your peer is routing its traffic over the VPN.
